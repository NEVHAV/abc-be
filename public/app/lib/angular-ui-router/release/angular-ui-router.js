...
var Transition = /** @class */ (function () {
     ...
     *
     * Each state can define one or more views (template/controllers), which are encapsulated as `ViewConfig` objects.
...
function ng1ViewsBuilder(state) {
    ...
    forEach(viewsObject, function (config, name) {
        ...
        // Do not allow a view to mix props for component-style view with props for template/controllers-style view
...
var Ng1ViewConfig = /** @class */ (function () {
    ...
    /**
     * Gets the controllers for a view configuration.
     *
     * @returns {Function|Promise.<Function>} Returns a controllers, or a promise that resolves to a controllers.
     */
 ...
 *
 * Note that when `controllerAs` is being used, `$resolve` is set on the controllers instance *after* the
 * controllers is instantiated.  The `$onInit()` hook can be used to perform initialization code which
